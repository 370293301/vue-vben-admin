...
import { Button, Select, DatePicker, Tag, message } from 'ant-design-vue'
...
<template>
  <Page auto-content-height>
    <div class="panel">
      <div class="toolbar">
        <RangePicker v-model:value="filters.dates" :inputReadOnly="true" style="width: 280px" />
        <Select
          ...
          style="width: 360px"
        >
          <Select.Option v-for="m in allMetrics" :key="m" :value="m">{{ m }}</Select.Option>
        </Select>
